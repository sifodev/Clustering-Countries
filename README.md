...
I tried to categorize the countries using some socio-economic and health factors that
determine the overall development of
the country. Then I suggested the countries which the NGO CEO needs to focus on the
most. Clustered countries using both
Hierarchical Clustering and KMeans Clustering and selected the best fit model which
gives out countries which are in dire
need of help from NGO
